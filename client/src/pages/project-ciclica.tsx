  ...
  const features = [
    {
      ...
      description:
        "O app calcula automaticamente a fase atual com base nos registros da usuária, utilizando histórico real para prever menstruação, energia e mudanças hormonais de forma personalizada.",
    },
    {
      icon: Brain,
      title: "IA LunIA – sua coach de bem-estar",
      description:
        "A IA analisa o ciclo, sintomas, treinos feitos e humor para responder dúvidas, orientar treinos e oferecer motivação empática em cada fase.",
    },
    {
      icon: Dumbbell,
      title: "Treino do dia baseado na fase do ciclo",
      description:
        "Recomendações personalizadas de treino (A, B, C, D ou E) com progressão automática, vídeos integrados, barra de progresso e pontuação.",
    },
    {
      icon: Heart,
      title: "Registro de sintomas e sentimentos",
      description:
        "A usuária registra humor, desconfortos, notas e peso — tudo organizado por categorias, construindo um histórico completo por mês.",
    },
    {
      icon: Calendar,
      title: "Calendário Menstrual completo",
      description:
        "Visualização colorida por fase (menstruada, folicular, ovulatória, lútea), treinos realizados, sintomas registrados e relatório diário.",
    },
    {
      icon: Trophy,
      title: "Gamificação Lunar",
      description:
        "Sistema de Moedinha Lunar (XP por treinos e registros), Classe Lunar (Lua Nova, Crescente, Cheia e Minguante) e Medalha Lunar ao concluir treinos — tudo desenhado para motivar e acompanhar o progresso mês a mês.",
    },
    {
      icon: Sparkles,
      title: "Dashboard acolhedor e personalizado",
      description:
        "Saudação com nome, fase atual, treino do dia, pontuação, energia feminina e atalhos rápidos para registrar sintomas e acessar o histórico.",
    },
  ];
      ...
      <section className="py-20 px-4 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-12">
            <Badge
              className="mb-4 bg-gradient-to-r from-[#5C00AB] to-[#7CC7D8] text-white border-0"
              data-testid="badge-category"
            >
              Aplicativo Mobile
            </Badge>
            <h1
              className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-[#5C00AB] to-[#7CC7D8] bg-clip-text text-transparent"
              data-testid="text-project-title"
            >
              Cíclica
            </h1>
            <p
              className="text-xl md:text-2xl text-[#7CC7D8] mb-4"
            ...
            >
              Aplicativo mobile desenvolvido pela Thype Technology para
              acompanhar o ciclo menstrual, energia vital, sintomas, treinos e
              bem-estar feminino — tudo guiado pela IA LunIA, que entrega
              recomendações inteligentes e personalizadas para cada fase do
              ciclo.
            </p>
          </div>
          ...
          <Card className="backdrop-blur-lg bg-card/40 border border-primary/20 shadow-[0_0_30px_rgba(92,0,171,0.3)] p-8 mb-16">
            <h2
              className="text-3xl font-bold mb-6 bg-gradient-to-r from-[#5C00AB] to-[#7CC7D8] bg-clip-text text-transparent"
            ...
            >
              O Cíclica foi criado para oferecer autonomia, clareza e conexão
              com o corpo, reunindo em um só lugar monitoramento completo do
              ciclo, treinos alinhados à energia do dia, registro de
              sentimentos, histórico, calendário menstrual, gamificação e uma
      ...
      <section className="py-20 px-4 relative">
        <div className="max-w-7xl mx-auto">
          <h2
            ...
            data-testid="text-gamification-title"
          >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {gamification.map((item, index) => (
              ...
              >
                ...
                <h3
                  className="text-xl font-bold mb-3 text-card-foreground"
                  data-testid={`text-gamification-title-${index}`}
                >
                  {item.title}
                </h3>
                <p
                  className="text-muted-foreground leading-relaxed"
                  data-testid={`text-gamification-description-${index}`}
                >
                  {item.description}
                </p>
              </Card>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-12 text-center">
            <p
              ...
              data-testid="text-tech-note"
            >
              Arquitetura orientada a múltiplos módulos e IA integrada
            </p>
            <p
              className="text-muted-foreground text-lg mt-2"
              data-testid="text-design-note"
            >
              Design System feminino e acolhedor inspirado em wellness & ciclo
              menstrual
            </p>
          </div>
        </div>
      ...
      <section className="py-20 px-4 relative">
        <div className="max-w-4xl mx-auto">
          <Card className="backdrop-blur-lg bg-gradient-to-br from-[#5C00AB]/20 to-[#7CC7D8]/20 border border-primary/20 shadow-[0_0_50px_rgba(92,0,171,0.4)] p-12 text-center">
            <h2
              className="text-3xl md:text-4xl font-bold mb-6 bg-gradient-to-r from-[#5C00AB] to-[#7CC7D8] bg-clip-text text-transparent"
            ...
            <div className="space-y-4">
              <p
                className="text-card-foreground leading-relaxed text-lg"
                data-testid="text-result-content-1"
              >
                O Cíclica foi projetado para entregar clareza, acolhimento e
                inteligência, guiando a usuária a compreender seu corpo e sua
                energia em cada fase.
              </p>
              <p
                className="text-card-foreground leading-relaxed text-lg"
                data-testid="text-result-content-2"
              >
                Com uma estética moderna, feminina e suave, combinada a uma IA
                empática, o app cria uma experiência única onde tecnologia,
                autocuidado e ciência se encontram.
              </p>
              <p
                className="text-card-foreground leading-relaxed text-lg"
                data-testid="text-result-content-3"
              >
                É uma solução completa para quem deseja entender o ciclo,
                treinar no momento certo, acompanhar sentimentos e evoluir com
                consciência — dia após dia, mês após mês.
              </p>
            </div>
          </Card>
        </div>
