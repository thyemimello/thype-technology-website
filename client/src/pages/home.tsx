...
export default function Home() {
  ...
  const openInstagram = () => {
    const instagramUrl = 'https://www.instagram.com/thype_aisolutions?igsh=aTQxZ2hkMjRtb2p5&utm_source=qr';
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-hidden">
      ...
      <div className="fixed inset-0 z-0">
        ...
        <div className="absolute top-40 right-20 w-80 h-80 bg-[#2D67CE] rounded-full blur-[140px] opacity-30 animate-pulse" style={{ animationDelay: '1s' }} />
        <div className="absolute bottom-20 left-1/3 w-96 h-96 bg-[#7CC7D8] rounded-full blur-[160px] opacity-20 animate-pulse" style={{ animationDelay: '2s' }} />
      </div>
      ...
      <div className="relative z-10">
        ...
        <section id="hero" className="relative min-h-screen overflow-hidden">
          ...
          <nav className="absolute top-0 left-0 right-0 z-50 flex items-center justify-between px-6 md:px-12 py-6">
            ...
            <div className="flex items-center gap-3 z-50">
              ...
              >
                <span className={`w-6 h-0.5 bg-foreground transition-transform duration-300 ${menuOpen ? 'rotate-45 translate-y-2' : ''}`}></span>
                <span className={`w-6 h-0.5 bg-foreground transition-opacity duration-300 ${menuOpen ? 'opacity-0' : ''}`}></span>
                <span className={`w-6 h-0.5 bg-foreground transition-transform duration-300 ${menuOpen ? '-rotate-45 -translate-y-2' : ''}`}></span>
              </button>
            </div>
            ...
            `} data-testid="menu-navigation">
              <li onClick={() => setMenuOpen(false)} className="cursor-pointer hover:text-[#7CC7D8] transition-colors" data-testid="link-menu-home">{t('nav.home')}</li>
              <li onClick={() => { setMenuOpen(false); scrollToSection('quem-somos'); }} className="cursor-pointer hover:text-[#7CC7D8] transition-colors" data-testid="link-menu-about">{t('nav.about')}</li>
              <li onClick={() => { setMenuOpen(false); scrollToSection('produtos'); }} className="cursor-pointer hover:text-[#7CC7D8] transition-colors" data-testid="link-menu-services">{t('nav.services')}</li>
              <li onClick={() => { setMenuOpen(false); scrollToSection('portfolio'); }} className="cursor-pointer hover:text-[#7CC7D8] transition-colors" data-testid="link-menu-portfolio">{t('nav.portfolio')}</li>
              <li onClick={() => { setMenuOpen(false); scrollToSection('contato'); }} className="cursor-pointer hover:text-[#7CC7D8] transition-colors" data-testid="link-menu-contact">{t('nav.contact')}</li>
              <Button 
          ...
          <div className="relative z-10 flex items-center justify-center min-h-screen px-4 md:px-6 lg:px-12 py-20 md:py-0">
            <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-center">
              ...
              <div className="space-y-4 md:space-y-6 text-center lg:text-left order-2 lg:order-1">
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight" data-testid="text-hero-title">
                ...
                <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-foreground/90 leading-relaxed" data-testid="text-hero-subtitle">
                  {t('hero.subtitle')}
                </p>
              ...
              {/* Spline 3D Robot */}
              <div className="relative h-[280px] sm:h-[350px] md:h-[450px] lg:h-[550px] xl:h-[600px] flex items-center justify-center overflow-visible order-1 lg:order-2" data-testid="container-spline-robot">
                <div className="absolute inset-0 flex items-center justify-center" style={{ transform: "translate(-10%, -10%)" }}>
                  <SafeSpline
          ...
          <div className={`max-w-7xl mx-auto transition-all duration-1000 ${
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <h2 className="text-3xl md:text-5xl font-bold bg-gradient-to-r from-[#5C00AB] to-[#7CC7D8] bg-clip-text text-transparent mb-6" data-testid="text-about-title">
                  {t('about.title')}
                </h2>
                ...
                <Card className="backdrop-blur-lg bg-card/40 border border-primary/20 shadow-[0_0_30px_rgba(92,0,171,0.3)] hover:shadow-[0_0_40px_rgba(92,0,171,0.5)] transition-shadow duration-300 p-8">
                  <div className="space-y-4 text-card-foreground leading-relaxed" data-testid="text-about-content">
                    <p>
                      {t('about.p1')}
                    </p>
                    <p>
              ...
              <div className="flex justify-center lg:justify-end">
                ...
                >
                  <img 
                    ...
                    style={{
                      filter: 'drop-shadow(0 0 60px rgba(124,199,216,0.6)) drop-shadow(0 0 100px rgba(92,0,171,0.4))',
                    }}
        ...
        >
          <div className={`max-w-7xl mx-auto transition-all duration-1000 ${
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-center mb-6 bg-gradient-to-r from-[#5C00AB] to-[#7CC7D8] bg-clip-text text-transparent" data-testid="text-products-title">
              {t('products.title')}
            </h2>
                ...
                >
                  <div className="space-y-4">
                    <div className="w-14 h-14 rounded-md bg-gradient-to-br from-[#5C00AB] to-[#2D67CE] flex items-center justify-center group-hover:shadow-[0_0_20px_rgba(92,0,171,0.6)] transition-shadow">
                      <product.icon className="w-7 h-7 text-primary-foreground" data-testid={`icon-product-${index}`} />
                    </div>
                    <h3 className="text-xl font-semibold text-foreground" data-testid={`title-product-${index}`}>
                      {product.title}
                    </h3>
                    <p className="text-muted-foreground leading-relaxed" data-testid={`description-product-${index}`}>
                      {product.description}
                    </p>
                  </div>
                </Card>
            ...
            <Card className="backdrop-blur-lg bg-card/40 border border-primary/20 shadow-[0_0_30px_rgba(92,0,171,0.3)] hover:shadow-[0_0_40px_rgba(92,0,171,0.5)] transition-shadow duration-300 p-8">
              <p className="text-center text-lg text-card-foreground leading-relaxed" data-testid="text-products-footer">
                {t('products.footer')}
              </p>
            </Card>
          </div>
          ...
          <div className={`max-w-7xl mx-auto transition-all duration-1000 ${
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="flex justify-center lg:justify-start order-2 lg:order-1">
                <div 
                  ...
                  style={{
                    ...
                    transform: `translateY(${getParallax(-0.08, 30)}px) translateX(${getParallax(0.05, 20)}px)`,
                  }}
                >
                  <div className="relative w-full h-full flex items-center justify-center">
                    <img 
                      ...
                      style={{
                        filter: 'drop-shadow(0 0 40px rgba(124,199,216,0.8)) drop-shadow(0 0 80px rgba(45,103,206,0.6))',
              ...
              <div className="space-y-6 order-1 lg:order-2">
                <h2 className="text-3xl md:text-5xl font-bold bg-gradient-to-r from-[#5C00AB] to-[#7CC7D8] bg-clip-text text-transparent" data-testid="text-differentials-title">
                  {t('differentials.title')}
                </h2>
                
                <Card className="backdrop-blur-lg bg-card/40 border border-primary/20 shadow-[0_0_30px_rgba(92,0,171,0.3)] hover:shadow-[0_0_40px_rgba(92,0,171,0.5)] transition-shadow duration-300 p-8">
                  <div className="space-y-6">
                    {(t('differentials.list') as string[]).map((differential: string, index: number) => (
                      <div 
                        key={index} 
                        className="flex items-start gap-4 group"
                        data-testid={`item-differential-${index}`}
                      >
                        <CheckCircle2 className="w-6 h-6 text-[#7CC7D8] flex-shrink-0 mt-1 group-hover:text-[#2D67CE] transition-colors" data-testid={`icon-differential-${index}`} />
                        <p className="text-card-foreground leading-relaxed" data-testid={`text-differential-${index}`}>
                          {differential}
                        </p>
                      </div>
                    ))}
        ...
        >
          <div className={`max-w-7xl mx-auto transition-all duration-1000 ${
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-center mb-16 bg-gradient-to-r from-[#5C00AB] to-[#7CC7D8] bg-clip-text text-transparent" data-testid="text-portfolio-title">
              {t('portfolio.title')}
            </h2>
            ...
            <Card className="backdrop-blur-lg bg-gradient-to-br from-[#5C00AB]/20 to-[#2D67CE]/20 border border-primary/30 shadow-[0_0_50px_rgba(92,0,171,0.4)] hover:shadow-[0_0_60px_rgba(92,0,171,0.6)] transition-all duration-300 overflow-hidden mb-12">
              <div className="grid lg:grid-cols-2 gap-8 p-8 md:p-12">
                <div className="space-y-6 flex flex-col justify-center">
                  ...
                  <h3 className="text-3xl md:text-4xl font-bold text-foreground" data-testid="text-ciclica-title">
                    {t('portfolio.ciclica.title')}
                  </h3>
                  <p className="text-lg text-muted-foreground leading-relaxed" data-testid="text-ciclica-description">
            ...
            <Card className="backdrop-blur-lg bg-gradient-to-br from-[#2D67CE]/20 to-[#7CC7D8]/20 border border-accent/30 shadow-[0_0_50px_rgba(45,103,206,0.4)] hover:shadow-[0_0_60px_rgba(45,103,206,0.6)] transition-all duration-300 overflow-hidden mb-12">
              <div className="grid lg:grid-cols-2 gap-8 p-8 md:p-12">
                <div className="space-y-6 flex flex-col justify-center">
                  ...
                  <h3 className="text-3xl md:text-4xl font-bold text-foreground" data-testid="text-radar-title">
                    {t('portfolio.radar.title')}
                  </h3>
                  <p className="text-lg text-muted-foreground leading-relaxed" data-testid="text-radar-description">
            ...
            <Card className="backdrop-blur-lg bg-gradient-to-br from-[#1C8DDB]/20 to-[#5C00AB]/20 border border-primary/30 shadow-[0_0_50px_rgba(28,141,219,0.4)] hover:shadow-[0_0_60px_rgba(28,141,219,0.6)] transition-all duration-300 overflow-hidden">
              <div className="grid lg:grid-cols-2 gap-8 p-8 md:p-12">
                <div className="space-y-6 flex flex-col justify-center">
                  ...
                  <h3 className="text-3xl md:text-4xl font-bold text-foreground" data-testid="text-otimizador-title">
                    {t('portfolio.otimizador.title')}
                  </h3>
                  <p className="text-lg text-muted-foreground leading-relaxed" data-testid="text-otimizador-description">
        ...
        >
          <div className={`max-w-7xl mx-auto transition-all duration-1000 ${
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-center mb-6 bg-gradient-to-r from-[#5C00AB] to-[#7CC7D8] bg-clip-text text-transparent" data-testid="text-testimonials-title">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {(t('testimonials.items') as any[]).map((testimonial: any, index: number) => (
                <Card 
                  key={index}
                ...
                >
                  <div className="space-y-6">
                    ...
                    <div className="w-12 h-12 rounded-md bg-gradient-to-br from-[#5C00AB] to-[#2D67CE] flex items-center justify-center group-hover:shadow-[0_0_20px_rgba(92,0,171,0.6)] transition-shadow">
                      <Quote className="w-6 h-6 text-primary-foreground" data-testid={`icon-quote-testimonial-${index}`} />
                    </div>

                    {/* Testimonial Text */}
                    <p className="text-card-foreground leading-relaxed italic" data-testid={`text-testimonial-${index}`}>
                      "{testimonial.text}"
                    </p>
                    ...
                    <div className="pt-4 border-t border-primary/20">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground" data-testid={`role-testimonial-${index}`}>
                            {testimonial.role}
                          </p>
                          <p className="text-xs text-muted-foreground/80" data-testid={`company-testimonial-${index}`}>
                            {testimonial.company}
                          </p>
                        </div>
                      </div>
        ...
        >
          <div className={`max-w-7xl mx-auto transition-all duration-1000 ${
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-center mb-6 bg-gradient-to-r from-[#5C00AB] to-[#7CC7D8] bg-clip-text text-transparent" data-testid="text-team-title">
              {t('team.title')}
            </h2>
            <p className="text-center text-muted-foreground mb-16 max-w-2xl mx-auto">
              {t('team.subtitle')}
                ...
                >
                  <div className="space-y-6">
                    <div className="w-16 h-16 rounded-md bg-gradient-to-br from-[#5C00AB] to-[#2D67CE] flex items-center justify-center group-hover:shadow-[0_0_20px_rgba(92,0,171,0.6)] transition-shadow">
                      <member.icon className="w-8 h-8 text-primary-foreground" data-testid={`icon-team-${index}`} />
                    </div>
                    <h3 className="text-2xl font-semibold text-foreground" data-testid={`title-team-${index}`}>
                      {t(`team.${member.key}.title`)}
                    </h3>
                    <p className="text-sm font-medium text-[#7CC7D8]" data-testid={`subtitle-team-${index}`}>
                      {t(`team.${member.key}.subtitle`)}
                    </p>
                    <p className="text-muted-foreground leading-relaxed" data-testid={`description-team-${index}`}>
          ...
          <div className={`max-w-4xl mx-auto transition-all duration-1000 ${
            ...
            <Card className="backdrop-blur-lg bg-gradient-to-br from-[#5C00AB]/30 via-[#2D67CE]/30 to-[#7CC7D8]/30 border border-primary/30 shadow-[0_0_60px_rgba(92,0,171,0.5)] hover:shadow-[0_0_70px_rgba(92,0,171,0.7)] transition-all duration-300 p-12 md:p-16 text-center">
              <div className="space-y-8">
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-[#7CC7D8] to-[#5C00AB] bg-clip-text text-transparent" data-testid="text-contact-title">
                ...
                <div className="flex flex-wrap gap-6 justify-center pt-8">
                  {/* WhatsApp */}
                  <div className="flex flex-col items-center gap-3 group cursor-pointer" onClick={openWhatsApp} data-testid="button-contact-whatsapp">
                    ...
                    <span className="text-sm font-medium text-muted-foreground group-hover:text-[#25D366] transition-colors">{t('contactSection.whatsapp')}</span>
                  </div>

                  {/* Telefone */}
                  <div className="flex flex-col items-center gap-3 group cursor-pointer" onClick={() => window.location.href = 'tel:+5547988140013'} data-testid="button-contact-call">
                    ...
                    <span className="text-sm font-medium text-muted-foreground group-hover:text-[#5C00AB] transition-colors">{t('contactSection.call')}</span>
                  </div>

                  {/* Email */}
                  <div className="flex flex-col items-center gap-3 group cursor-pointer" onClick={() => openContactDialog('contact')} data-testid="button-contact-form">
                    ...
                    <span className="text-sm font-medium text-muted-foreground group-hover:text-[#7CC7D8] transition-colors">{t('contactSection.email')}</span>
                  </div>

                  {/* Instagram */}
                  <div className="flex flex-col items-center gap-3 group cursor-pointer" onClick={openInstagram} data-testid="button-contact-instagram">
                    ...
                    <span className="text-sm font-medium text-muted-foreground group-hover:text-[#E1306C] transition-colors">{t('contactSection.instagram')}</span>
                  </div>
                </div>
              </div>
            </Card>
